"""
REST API сервис для нового интернет магазина.
"""
import argparse
import logging
import os
...
from magicComparator.api.app import create_app
from magicComparator.utils.argparse import clear_environ, positive_int
from magicComparator.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'MAGIC_COMPARATOR_'
...
def main():
    ...
    # Очищаем переменные окружения, чтобы не дать им случайно куда-либо утечь
